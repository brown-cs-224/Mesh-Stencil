...
- Mesh validation **(10 points)**
- Loop subdivision **(20 points)**
- Simplification using quadric error metrics **(30 points)**
- Another geometry processing function **(25 points for correctness; 5 points for efficiency)**
- README **(5 points)**
- Example results generated by your code **(5 points)**
...
This file **(5 points)** should describe how to run your code to reproduce the results shown in your submitted images (which should be embedded in the README file). **This must not require a modification to the source code itself**. Use command-line arguments (or a GUI, if you like) to change program behavior.
...
//TODO: add grading explanation like for path
...
`./<program-name> <input-obj> <output-obj> <method-name> <arg1> <arg2> <arg3> <arg4>`
